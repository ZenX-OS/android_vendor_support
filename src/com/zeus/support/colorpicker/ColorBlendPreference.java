...
package com.zeus.support.colorpicker;
...
import com.zeus.support.colorpicker.ColorPickerDialog;

import com.android.internal.util.zeus.ZeusUtils;

import com.zeus.support.R;
...
public class ColorBlendPreference extends Preference
    ...
    private void updateDialogSliderPreview() {
        ...
        mDialogPreviewColorBetween.setBackgroundColor(
                ZeusUtils.getBlendColorForPercent(mPreviewColorEnd, mPreviewColorStart,
    ...
    private void updatePreview() {
        ...
        if (mViewColorBetween != null) {
            mViewColorBetween.setBackgroundColor(
                    ZeusUtils.getBlendColorForPercent(mColorEnd, mColorStart, mBlendReverse, 50));
        }
    }
